...
class NashQLearning:
    ...
    def fit(self, return_history=False):
        ...
        for init_state in reversed(self.env.joint_states):
            ...
            for episode in range(update_num):
                ...
                if prev_q_vector is not None:
                    ...
                    if relative_diff < 1e-5:  # 1e-5 代表 0.001% 的变化
                        stable_counter += 1
                    else:
                        stable_counter = 0
                ...
                #Early Stopping
                if stable_counter >= required_stable_episodes:
        ...
        #     ax1.plot(x, learning_curve_data['Q0_(0,0)'], label="Q0_(Stay, Stay)")
        #     ax1.plot(x, learning_curve_data['Q0_(0,1)'], label="Q0_(Stay, Leave)")
        ...
        # with open(learning_curve_data_path, 'w') as f:
        #     json.dump(convergence_speed_path, f)  

...
class Value_iteration():
    ...
    def solve(self, max_iter = 1000, theta = 1.0e-8):
        ...
        for iter in range(max_iter):
            ...
            for s in range(self.n_states):
                for a in range(self.a_size):
                    ...
                    for t in enumerate(possible_transitions):
                        ...
                        #t[1][0]:prob  t[1][2]:reward  t[1][1]:n-s
            ...
            self.q_table = copy.deepcopy(new_q)

            # print(iter, max_delta)
            if max_delta < theta:
                break
        return policy, self.v_table, self.q_table  # return policies and optimal values
